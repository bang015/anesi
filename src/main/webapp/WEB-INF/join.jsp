...
<div id="app">
	...
	<div><input class="email" type="text" v-model="user.userEmail1" @click="fnMailCheck" @keyup="fnMailCheck" placeholder="이메일"> @ 
	...
	<div><input class="put" type="password" v-model="user.pw1" placeholder="비밀번호" @click="fnPwdCheck" @keyup="fnPwdCheck"></div>
	<div><span class="red">{{pw1Ms}}</span></div>
	</div>
	<div class="part">
	<div><h2>비밀번호 확인<span class="clause1"> *</span></h2></div>
	<div><input class="put" type="password" v-model="user.pw2" placeholder="비밀번호 확인" @click="fnPwd2Check" @keyup="fnPwd2Check"></div>
	<div><span class="red">{{pw2Ms}}</span></div>
	</div>
	<div class="part">
	<div><h2>이름<span class="clause1"> *</span></h2></div>
	<div><input class="put" type="text" v-model="user.userName" placeholder="이름" @click="fnNameCheck" @keyup="fnNameCheck"></div>
	<div><span class="red">{{nameMs}}</span></div>
	</div>
	<div class="part">
	<div><h2>닉네임<span class="clause1"> *</span></h2></div>
	<div><input class="put" type="text" v-model="user.nick" placeholder="닉네임" @click="fnNickCheck" @keyup="fnNickCheck"></div>
	<div><span class="red">{{nickMs}}</span></div>
	</div>
	<div class="part">
	<div><h2>휴대폰 번호<span class="clause1"> *</span></h2></div>
	<div><input class="put" type="text" v-model="user.phone" placeholder="휴대폰 번호 '-'제외 숫자만 입력해주세요." @click="fnPhoneCheck" @keyup="fnPhoneCheck"></div>
	...
	<div><label><input type="checkbox" v-model="clause" value="cla"> 이용약관<span class="clause1">(필수)</span></label></div>
	<div><label><input type="checkbox" v-model="clause" value="cla2"> 개인정보수집 및 이용동의<span class="clause1">(필수)</span></label></div>
	<div><label><input type="checkbox" v-model="clause" value="sms"> 이벤트, 쿠폰, 특가 알림 메일 및 SMS 등 수신<span class="clause2">(선택)</span></label></div>
	<hr>
